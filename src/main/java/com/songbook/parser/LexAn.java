...
/**
 * Lexical-Analyzer of Guitar Song Book Editor providing Lexical-Elements for the SyntaxAnalyzer.
...
public class LexAn {
    ...
    public static class LexElement {
        ...
        private final LexElement.Type type;
    ...
    private final InputSys inputSys;
